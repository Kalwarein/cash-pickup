...
const STEP_COLORS = [
  { c: '#6366f1', bg: 'rgba(99,102,241,0.12)',  glow: 'rgba(99,102,241,0.25)'  },
  { c: '#06b6d4', bg: 'rgba(6,182,212,0.12)',   glow: 'rgba(6,182,212,0.25)'   },
  { c: '#8b5cf6', bg: 'rgba(139,92,246,0.12)',  glow: 'rgba(139,92,246,0.25)'  },
  { c: '#10b981', bg: 'rgba(16,185,129,0.12)',  glow: 'rgba(16,185,129,0.25)'  },
  { c: '#f59e0b', bg: 'rgba(245,158,11,0.12)',  glow: 'rgba(245,158,11,0.25)'  },
  { c: '#3b82f6', bg: 'rgba(59,130,246,0.12)',  glow: 'rgba(59,130,246,0.25)'  },
  { c: '#ef4444', bg: 'rgba(239,68,68,0.12)',   glow: 'rgba(239,68,68,0.25)'   },
  { c: '#22c55e', bg: 'rgba(34,197,94,0.12)',   glow: 'rgba(34,197,94,0.25)'   },
  { c: '#ec4899', bg: 'rgba(236,72,153,0.12)',  glow: 'rgba(236,72,153,0.25)'  },
  { c: '#f97316', bg: 'rgba(249,115,22,0.12)',  glow: 'rgba(249,115,22,0.25)'  },
  { c: '#14b8a6', bg: 'rgba(20,184,166,0.12)',  glow: 'rgba(20,184,166,0.25)'  },
  { c: '#a855f7', bg: 'rgba(168,85,247,0.12)',  glow: 'rgba(168,85,247,0.25)'  },
  { c: '#64748b', bg: 'rgba(100,116,139,0.12)', glow: 'rgba(100,116,139,0.25)' },
  { c: '#0ea5e9', bg: 'rgba(14,165,233,0.12)',  glow: 'rgba(14,165,233,0.25)'  },
];
